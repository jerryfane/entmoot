...
\begin{abstract}
\noindent
Between 17 and 22 April 2026 we shipped a dense sequence of
patch releases across two layered systems: eleven Pilot fork releases
(\texttt{v1.7.2-jf.1} through \texttt{v1.9.0-jf.7}) and eleven
Entmoot releases (\texttt{v1.0.0} through \texttt{v1.2.1}). Every
patch was driven by a symptom observed on a three-machine live
demo across three continents: a laptop on a UAE carrier-grade NAT,
a Raspberry Pi in Italy on Fastweb residential, and a Hetzner VPS
in Germany. The CHANGELOGs document what changed, but their
...
\bottomrule
\end{tabular}
\caption{Pilot fork release summary.}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Entmoot release summary (through 22 April 2026).}
\end{table}
