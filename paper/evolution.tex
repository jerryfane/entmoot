...
\begin{abstract}
\noindent
Between 17 and 21 April 2026 we shipped a dense sequence of
patch releases across two layered systems: ten Pilot fork releases
(\texttt{v1.7.2-jf.1} through \texttt{v1.9.0-jf.6}) and nine
Entmoot releases (\texttt{v1.0.0} through \texttt{v1.1.0}). Every
...
\bottomrule
\end{tabular}
\caption{Entmoot release summary.}
\end{table}
