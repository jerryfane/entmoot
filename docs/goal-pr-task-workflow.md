# Goal Prompt: Task-by-Task PR Workflow

Use this prompt with `/goal` when you have an implementation plan split into
ordered tasks and want each task delivered through its own clean pull request.
