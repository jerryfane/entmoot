...
const (
	...
	signRequestKindGroupPolicyUpdate  = "group_policy_update"
	signRequestKindGroupPolicyClear   = "group_policy_clear"
	signRequestKindGroupPublicPublish = "group_public_publish"
	...
	signRequestKindFleetRestore       = "fleet_restore"
