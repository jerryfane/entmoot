...
func Encode(v any) (MsgType, []byte, error) {
	...
	case *Reconcile:
		t = MsgReconcile
	case *MemberProfileAd:
		t = MsgMemberProfileAd
	case *MemberProfileSnapshotReq:
...
func Decode(t MsgType, body []byte) (any, error) {
	...
	case MsgMemberProfileAd:
		return decodeAs[MemberProfileAd](t, body)
	...
	case MsgAcceptanceReq:
		return decodeAs[AcceptanceReq](t, body)
	case MsgAcceptanceResp:
		return decodeAs[AcceptanceResp](t, body)
	default:
